...
class FieldBoolean (tk.Checkbutton):
	...
	def _validate_field (self, nm, idx, mode):
		"""Validation function which notifies update callbacks when the value is changed,
		and sets the status to UNSAVED."""
	...
	def set_raw (self, raw):
		"""Sets the internal raw value, viewable value, and sets the checkbox."""
		if raw == None:
